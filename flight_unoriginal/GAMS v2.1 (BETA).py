...
class passenger:
    ...
    def storedata(self):
        self.id=eval(input ('Enter id: '))
        self.name=input('Enter name: ')
        self.birthday=input('Enter your date of birth--')
        self.age=input('Enter Your age--')
        self.gender=input('Enter your gender(M/F)--')
        self.flightclass=input('Enter prefered flight class(F-Firstclass ,B-Bussinessclass,E-Economyclass--')
        self.transcode='code'
...
class flight_detail: #ADMIN
    ...
    def storedata(self):
        self.flight_num=input('Enter FLIGHT NUMER--')
        self.origin_name=input('Enter departure location--')
        self.dest_name=input('Enter arrival location--')
        self.date=input('Enter departure date--')
        self.firstclass=eval(input('Enter no. of first class seats:-'))
        self.fir_price=eval(input('Enter the price for first class seat:-'))
        self.businessclass=eval(input('Enter no. of business class seats:-'))
        self.bus_price=eval(input('Enter the price for business class seat:-'))
        self.economyclass=eval(input('Enter no. of economy class seat:-'))
        self.eco_price=eval(input('Enter the price of economy class seat:-'))
        print()


    def timing(self):  #For providing additional times for same flight per day
        self.time_depart=input('Enter the time of departure--')
        self.time_arrive=input('Enter the time of arrival--')
        print()
...
def create_passenger(flnum1):
    ...
    n=eval(input("Enter the no. of passengers(including you!):"))
    p=passenger()
...
def create_flight():
    ...
    n=eval(input("Enter the no. of flight plans:-"))
    fl=flight_detail()
    for i in range(n):
        fl.storedata()
        t=eval(input('Enter no. flight times for this day--'))
        for j in range(t):
            fl.timing()
        pickle.dump(fl,f)
    f.close()
...
def delete():
    flight_num=input("Enter the flight id(num) of the flight whose details are  to be deleted: ")
...
def modify():
    flight_num=eval(input("Enter the flight id  whose details are to be modified : "))
...
def search():
    flight_num=input("Enter the flight num of the flight to be searched :")
